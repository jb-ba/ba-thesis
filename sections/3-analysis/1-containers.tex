...
\input{sections/3-analysis/containers/resourceConsumption.tex}
\input{sections/3-analysis/containers/hardwareAccess.tex}
\input{sections/3-analysis/containers/security.tex}
