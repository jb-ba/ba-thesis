...
The device edge is operated by normal households and other non network-related businesses. It is respsonsible for the control and data plane of the constrained devices (explained below). This layerThe data from these devices can be aggregated and processed on . 
